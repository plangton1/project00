            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                <a class="
                  ...
                  <img src="./c/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31" />
                </a>
                <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href=""><i class="mdi mdi-account me-1 ms-1"></i> ข้อมูลส่วนตัว</a>
                  ...
                  <a class="dropdown-item" href=""><i class="mdi mdi-settings me-1 ms-1"></i> Account
                    Setting</a>
                  <div class="dropdown-divider"></div>
