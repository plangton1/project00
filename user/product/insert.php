...
if (isset($_POST) && !empty($_POST)) {
     ...
     $product_sup = $_REQUEST["product_sup"];
     $product_end = $_REQUEST["product_end"];
     $created_at = '';
     // print_r($_POST);
     if ($_POST["product_id"] == '') {
        if (isset($_FILES['product_img']['name']) && !empty($_FILES['product_img']['name'])) {
          ...
          $query = "  
           INSERT INTO product(product_id,product_name,product_price,product_net,product_type,product_detail,product_img,product_sale,product_unit,product_end,product_sup)  
           VALUES('$product_id' , '$product_name','$product_price','$product_net','$product_type','$product_detail','$filename','$product_sale','$product_unit','$product_end','$product_sup');  
           ";
